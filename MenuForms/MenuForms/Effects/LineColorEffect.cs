...
namespace MenuForms.Effects
{
    public static class LineColorEffect
    {
        ...
        {
            public EntryLineColorEffect() : base("OneAppForms.EntryLineColorEffect")
            {
            }
        }
        ...
        {
            public DatePickerLineColorEffect() : base("OneAppForms.DatePickerLineColorEffect")
            {
            }
        }
        ...
        {
            public PickerLineColorEffect() : base("OneAppForms.PickerLineColorEffect")
            {
            }
        }
    }
